...
[CreateAssetMenu(menuName = "Plasma/Plasma Category")]
public class PlasmaCategory : Definition
{
    [SerializeField, LocalizedStringFormat("plasmaCategory.{0}.name", "Plasma Category name - {0}"), Tooltip("Category name")]
    private LocalizedString m_name = LocalizedString.Null;

    [SerializeField, LocalizedStringFormat("plasmaCategory.{0}.description", "Plasma Category description - {0}", 6), Tooltip("Category description")]
