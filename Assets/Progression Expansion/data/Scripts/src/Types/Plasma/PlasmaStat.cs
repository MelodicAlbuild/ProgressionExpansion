...
[CreateAssetMenu(menuName = "Plasma/Plasma Stat")]
public class PlasmaStat : Property
{
    [SerializeField, Tooltip("Property type"), FormerlySerializedAs("Type")]
    private PropertyType m_type = null;

    [SerializeField, LocalizedStringFormat("plasmaStat.{0}.name", "Plasma Stat name - {0}"), Tooltip("Name of the stat")]
    private LocalizedString m_name = LocalizedString.Null;

    [SerializeField, LocalizedStringFormat("plasmaStat.{0}.description", "Plasma Stat description - {0}", 6), Tooltip("Description of the stat")]
    ...
    protected void SetNameFromFile()
    {
        ...
        UnityEditor.Undo.RegisterCompleteObjectUndo(this, "PlasmaStat name from file");
