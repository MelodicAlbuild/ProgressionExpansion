...
[CreateAssetMenu(menuName = "Alloys/Alloy Stat")]
public class AlloyStat : Property
{
    [SerializeField, Tooltip("Property type"), FormerlySerializedAs("Type")]
    private PropertyType m_type = null;

    [SerializeField, LocalizedStringFormat("alloyStat.{0}.name", "Alloy Stat name - {0}"), Tooltip("Name of the stat")]
    private LocalizedString m_name = LocalizedString.Null;

    [SerializeField, LocalizedStringFormat("alloyStat.{0}.description", "Alloy Stat description - {0}", 6), Tooltip("Description of the stat")]
    ...
    protected void SetNameFromFile()
    {
        ...
        UnityEditor.Undo.RegisterCompleteObjectUndo(this, "AlloyStat name from file");
