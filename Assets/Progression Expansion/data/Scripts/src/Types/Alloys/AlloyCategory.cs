...
[CreateAssetMenu(menuName = "Alloys/Alloy Category")]
public class AlloyCategory : Definition
{
    [SerializeField, LocalizedStringFormat("alloyCategory.{0}.name", "Alloy Category name - {0}"), Tooltip("Category name")]
    private LocalizedString m_name = LocalizedString.Null;

    [SerializeField, LocalizedStringFormat("alloyCategory.{0}.description", "Alloy Category description - {0}", 6), Tooltip("Category description")]
