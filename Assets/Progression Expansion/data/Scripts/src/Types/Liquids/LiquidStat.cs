...
[CreateAssetMenu(menuName = "Liquids/Liquid Stat")]
public class LiquidStat : Property
{
    [SerializeField, Tooltip("Property type"), FormerlySerializedAs("Type")]
    private PropertyType m_type = null;

    [SerializeField, LocalizedStringFormat("liuqidStat.{0}.name", "Liuqid Stat name - {0}"), Tooltip("Name of the stat")]
    private LocalizedString m_name = LocalizedString.Null;

    [SerializeField, LocalizedStringFormat("liuqidStat.{0}.description", "Liuqid Stat description - {0}", 6), Tooltip("Description of the stat")]
    ...
    protected void SetNameFromFile()
    {
        ...
        UnityEditor.Undo.RegisterCompleteObjectUndo(this, "LiquidStat name from file");
